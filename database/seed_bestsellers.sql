-- ================================================================
-- Sweets Website — Best Sellers Seed
-- File: seed_bestsellers.sql
-- Description: Comprehensive seed data for all best seller products
-- ================================================================
...
(1, 'Karadant', 'karadant', 1),
(2, 'Laddu', 'laddu', 1),
(3, 'Gift Box', 'gift-box', 1),
(4, 'Namkeen', 'namkeen', 1);

-- 2. Clean Existing Best Seller Data to avoid duplicates/conflicts
DELETE FROM product_images WHERE product_id >= 1000;
DELETE FROM products WHERE id >= 1000;

-- 3. Core Products Table (Matching mockBestsellers slugs and data)
INSERT INTO products (id, category_id, name, slug, short_description, base_price, stock_quantity, featured, status)
VALUES
-- Karadant
...
-- 4. Product Images Mapping (Synchronized with code)
